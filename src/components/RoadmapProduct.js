			...
			{product && (
				<div style={{borderColor : color}} className={"w-full rounded-lg bg-white my-2 p-4 flex px-8 md:px-8 justify-between items-baseline sm:items-center space-x-8 border-t-[6px] "}>
					<div className='flex flex-col-reverse sm:flex-row '>
						<button className=" my-2 flex-row sm:w-[40px] flex px-4 py-2 sm:flex-col space-x-2 max-w-[78px] h-auto items-center justify-center sm:space-y-2 sm:space-x-0 sm:h-[55px] rounded-lg bg-[#f2f4ff] text-blue-600 font-bold sm:mx-1  bottom-0 left-0 ">
							<img src={Arrow} alt="" />
							<p>{upvotes}</p>
						</button>
